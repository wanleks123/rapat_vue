    ...
    column: {
        headerCell: ({ context, props }) => ({
            class: [
                ...
                // Position
                { 'sticky z-20 border-b': context?.frozen || context?.frozen === '' },
                ...
                // Color
                (context?.sortable  === '' || context?.sortable ) && context?.sorted
                    ? 'bg-highlight'
                ...
                // Transition
                { 'transition duration-200': context?.sortable  === '' || context?.sortable  },

                // Misc
                { 'cursor-pointer': context?.sortable  === '' || context?.sortable  },
                {
        ...
        bodyCell: ({ props, context, state, parent }) => ({
            class: [
                ...
                {
                    'bg-surface-0 dark:bg-surface-900':
                        parent.instance.frozenRow || context?.frozen || context?.frozen === ''
                },
