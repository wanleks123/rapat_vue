    ...
    label: ({ props, state, parent }) => {
        return {
            class: [
                ...
                'border-0',
                {
                    'text-surface-800 dark:text-white/80': state.d_value,
                    'text-surface-400 dark:text-surface-500': !state.d_value && state.focused,
                    'text-transparent': !state.d_value && !state.focused,
                },
