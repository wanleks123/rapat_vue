export default {
    ...
    dayCell: ({ attrs }) => ({
        class: [
            ...
            'data-[p-other-month=true]:text-surface-500 dark:data-[p-other-month=true]:text-white/50',
        ]
    }),
    weekLabelContainer: {
        class: [
    ...
    timePicker: ({ props }) => ({
        class: [
            ...
            // Borders
            {
                'border-t-1': !props.timeOnly,
                'border-solid border-surface-200': !props.timeOnly,

                // Spacing
                'pt-2 mt-2': !props.timeOnly,
            },
        ]
    }),
    separatorContainer: {
