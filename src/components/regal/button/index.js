export default {
    root: ({ props, context, parent, instance }) => ({
        class: [
            ...
            'leading-[normal]',
            {
                'px-3 py-2': props.size === null && !props.link,
                'text-sm py-1.5 px-3': props.size === 'small' && !props.link,
                'text-xl py-3 px-4': props.size === 'large' && !props.link
            },
            { 'gap-2': props.label !== null },
            {
                'px-0 py-2': props.label == null && props.icon !== null
            },
            {
                'px-0 gap-0': instance.hasIcon && !props.label && !props.badge,
            ...
            // Primary Text Button
            { 'text-primary-600 dark:text-primary-400': props.text && props.severity === null && !props.plain },
